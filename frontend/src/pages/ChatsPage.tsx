...
const ChatsPage = () => {
    ...
    return (
    <div className='font-inter max-w-[1800px] mx-auto md:flex'>
        {/* */}
        ...
        {/* Desktop right side*/}
        <div className=' hidden md:flex bg-[rgba(222,234,255,0.42)] h-screen w-full justify-center items-center'>
